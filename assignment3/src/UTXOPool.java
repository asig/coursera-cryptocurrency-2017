...
public class UTXOPool {
    ...
    public void addUTXO(UTXO utxo, Transaction.Output txOut) {
        System.err.println("Adding UTXO: " + utxo);
        H.put(utxo, txOut);
    }

    /** Removes the UTXO {@code utxo} from the pool */
    public void removeUTXO(UTXO utxo) {
        System.err.println("Removing UTXO: " + utxo);
        H.remove(utxo);
    }
    ...
    public boolean contains(UTXO utxo) {
        boolean res = H.containsKey(utxo);
        System.err.println("UTXO " + utxo + " contained? " + (res ? "yes" : "no"));
        return res;
    }
